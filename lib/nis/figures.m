...
plotrf(diracfilter,1,'diracfilter')
plotrf(sinusoidalfilter,1,'sinusoidalfilter')
plotrf(edgefilter,1,'edgefilter')
...
plotrf(XnoDC(:,indices(1:patchno)),5,'natimpatches')
...
histogram(diracoutputs,xrange*std(diracoutputs),'dirachistogram')
histogram(sinusoidaloutputs,xrange*std(sinusoidaloutputs),'sinusoidalhistogram')
histogram(edgeoutputs,xrange*std(edgeoutputs),'edgehistogram')
histogram(diracoutputs_noDC,xrange*std(diracoutputs_noDC),'dirachistogram_noDC')
histogram(sinusoidaloutputs_noDC,xrange*std(sinusoidaloutputs_noDC),'sinusoidalhistogram_noDC')
histogram(edgeoutputs_noDC,xrange*std(edgeoutputs_noDC),'edgehistogram_noDC')
...
plotsamplesize=500;
plot_withbigfont(X(1,1:plotsamplesize),X(2,1:plotsamplesize),'.')
print('-deps',[figurepath,'neighpixelscatterplot.eps'])
plot_withbigfont(XnoDC(1,1:plotsamplesize),XnoDC(2,1:plotsamplesize),'.')
...
plotrf(Cx0y0_withDC,1,'rowofcovmatrix_withDC')

plot_withbigfont([0:patchsize-1]-x0,Cx0y0_withDC(patchsize*(y0-1):patchsize*y0-1))
...
plotrf(Cx0y0_noDC,1,'rowofcovmatrix_noDC')

plot_withbigfont([0:patchsize-1]-x0,Cx0y0_noDC(patchsize*(y0-1):patchsize*y0-1))
...
plot_withbigfont(logfreq,logPf1,logfreq,logPf2);
...
plot_withbigfont(sqrt(freq),Pf1,sqrt(freq),Pf2);
...
plotrf(firstpcs,pcano,'firstpcs')

plotrf(hundredthpcs,pcano,'hundredthpcs')
...
plotrf(E(:,1:320),plotcols,'pca')

d=diag(D);
plot_withbigfont(1:patchsize^2-1,log10(d(1:patchsize^2-1)));
...
plot_withbigfont(percentagecounter,nyquistcumenergy1,'--',percentagecounter,nyquistcumenergy2,'--',percentagecounter,highestwantedcumenergy1,'-',percentagecounter,highestwantedcumenergy2,'-',percentagecounter,checkercumenergy,':')
print('-deps',[figurepath,'antialiasing.eps'])
plotrf(nyquistgrating1,1,'nyquistgrating')
plotrf(checkergrating,1,'checkergrating')
...
plotrf(threeICs,3,'threeicas') %This is Figure 6.5
