function X = sampleimages2(samples, winsize, filepath, doLog);
...
%Gather all tiff files from the directory
files = dir(strcat(filepath, '/*.tiff'));
